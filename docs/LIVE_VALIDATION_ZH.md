...
> **历史记录 / 已被 V2 取代（2026-07-30）**
>
> 本文记录旧版 2026-07-28 及更早的验证，仅供追溯。V2 已改为原子 observation、
> 推理后同 track 重验证、仅 MoveIt 可接真实执行、unknown-motion 锁存和更严格的
> 现场安全门。本文中的厂商 RRT/PBVS、三次重采样、旧路径、旧成功结果和解锁步骤
> 均不得用于当前操作或验收。当前唯一有效说明为项目根目录 `README_ZH.md`、
> `HANDOFF.md` 和 `docs/ARCHITECTURE_V2_ZH.md`。
