...
class GraspNetServer(Node):
    def __init__(self):
        ...
        self.declare_parameter('graspnet_root', '/home/ubuntu/open_source/graspnet-baseline')
        self.declare_parameter('checkpoint_path', '/home/ubuntu/models/graspnet/checkpoint-rs.tar')
